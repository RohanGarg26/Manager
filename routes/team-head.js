...
router.get('/my-tasks/:status', memberAuthMiddleware.memberIsAuth, teamHeadController.getMyTasks)

router.post('/dismiss-task', memberAuthMiddleware.memberIsAuth, teamHeadController.postDismissTask)

router.post('/complete-task', memberAuthMiddleware.memberIsAuth, teamHeadController.postCompleteTask)
